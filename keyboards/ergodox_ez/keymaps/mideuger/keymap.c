 ...
 * !-------+-----+-----+-----+-----+-------------! !-------+-----+-----+-----+-----+-----+-------!
 * |  TAB  |CIRC | AT  |HASH |AMPR |PERC |       | !       | DLR |HOME | UP  | END |     |  F12  |
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 * |  ESC  |LCTL |LALT |LGUI |LSFT |MINS |-------! !-------!EURO |LEFT |DOWN |RGHT |ARROW| CAPS  |
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 * | LSPO  |UNDO | CUT |COPY |PASTE|UNDS |       | !       |POUND|     |LOWER|GREAT|EXLM | RSPC  |
 * '-------+-----+-----+-----+-----+-------------' '-------------+-----+-----+-----+-----+-------'
 ...
 *                                                  generated by [keymapviz] */
  [_SYM] = LAYOUT_ergodox_pretty(
     ...
     KC_TAB, KC_CIRC,   KC_AT, KC_HASH, KC_AMPR, KC_PERC, XXXXXXX,                                     XXXXXXX,  KC_DLR, KC_HOME,   KC_UP,  KC_END, XXXXXXX,  KC_F12,
     KC_ESC, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_MINS,                                                          EURO, KC_LEFT, KC_DOWN, KC_RGHT,   ARROW, KC_CAPS,
    KC_LSPO,    UNDO,     CUT,    COPY,   PASTE, KC_UNDS, XXXXXXX,                                     XXXXXXX,   POUND, XXXXXXX,   LOWER, GREATER, KC_EXLM, KC_RSPC,
 ...
 *                                                  generated by [keymapviz] */
  [_NUM] = LAYOUT_ergodox_pretty(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
     KC_TAB, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX, XXXXXXX,                                     XXXXXXX, KC_ASTR,    KC_7,    KC_8,    KC_9, KC_SLSH, XXXXXXX,
     KC_ESC, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, XXXXXXX,                                                       KC_PLUS,    KC_4,    KC_5,    KC_6, KC_MINS, XXXXXXX,
    KC_LSPO, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX, XXXXXXX,                                     XXXXXXX,    KC_0,    KC_1,    KC_2,    KC_3,  KC_EQL, KC_RSPC,
