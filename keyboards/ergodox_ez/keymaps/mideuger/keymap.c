 ...
 * !-------+-----+-----+-----+-----+-------------! !-------+-----+-----+-----+-----+-----+-------!
 * |  TAB  |  Q  |  W  |  E  |  R  |  T  | MNXT  | ! VOLU  |  Y  |  U  |  I  |  O  |  P  | BSLS  |
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 ...
 *                               |  MEH  | HOME  | ! PGUP  | HYPR  |
 *                       .-------+-------+-------! !-------+-------+-------.
 *                       !NAV_BSP!FN_DEL |  END  | ! PGDN  |NUM_ENT!NAV_SPC!
 *                       !       !       !-------! !-------!       !       !
 *                       |       |       | LGUI  | ! LALT  |       |       |
 *                       '-----------------------' '-----------------------'
 *                                                  generated by [keymapviz] */
  [_QWERTY_HRM] = LAYOUT_ergodox_pretty(
    ...
    KC_LSPO,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_MPRV,                                     KC_VOLD,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSPC,
    XXXXXXX, XXXXXXX,KC_LCTRL, KC_LALT, KC_LGUI,                                                                           TTEXT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                                                    KC_MEH, KC_HOME, KC_PGUP, KC_HYPR,
                                                                             KC_END, KC_PGDN,
                                                         NAV_BSPC, FN_DEL, KC_LGUI, KC_LALT, NUM_ENT, NAV_SPC
  ),
/* .---------------------------------------------. .---------------------------------------------.
 * |  ESC  |  1  |  2  |  3  |  4  |  5  | MPLY  | ! MUTE  |  6  |  7  |  8  |  9  |  0  | MINS  |
 * !-------+-----+-----+-----+-----+-------------! !-------+-----+-----+-----+-----+-----+-------!
 ...
 *                                                  generated by [keymapviz] */
  [_NUM] = LAYOUT_ergodox_pretty(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                                                          KC_DOT, KC_COMM, XXXXXXX, XXXXXXX, XXXXXXX,
                                                                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                                                            XXXXXXX, XXXXXXX,
                                                          KC_BSPC,  KC_DEL, XXXXXXX, XXXXXXX,  KC_ENT,  KC_SPC
  ),
 ...
 * !-------+-----+-----+-----+-----+-------------! !-------+-----+-----+-----+-----+-----+-------!
 * |LOCKSCR|     |     |MS_U |     |     |RGB_VAD| !RGB_VAI|     |     |WH_D |     |     |PRTSCR5|
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 * |FORCEQ |     |MS_L |MS_D |MS_R |     |-------! !-------!     |WH_L |WH_U |WH_R |     |PRTSCR1|
 * !-------+-----+-----+-----x-----x-----!RGB_HUD! !RGB_HUI!-----x-----x-----+-----+-----+-------!
 * | DELAY |     |     |     |     |     |       | !       |     |ACL0 |ACL1 |ACL2 |     |PRTSCR2|
 * '-------+-----+-----+-----+-----+-------------' '-------------+-----+-----+-----+-----+-------'
 *  |      |     |     |     | HRM |                             !TGEXT|RESET|ORYX |     |PRTSCR|
 *  '------------------------------'                             '------------------------------'
 *                               .---------------. .---------------.
 *                               |       |       | !       |       |
 *                       .-------+-------+-------! !-------+-------+-------.
 ...
 *                                                  generated by [keymapviz] */
  [_EXTRA] = LAYOUT_ergodox_pretty(
    ...
    LOCKSCR, XXXXXXX, XXXXXXX, KC_MS_U, XXXXXXX, XXXXXXX, RGB_VAD,                                     RGB_VAI, XXXXXXX, XXXXXXX, KC_WH_D, XXXXXXX, XXXXXXX, PRTSCR5,
     FORCEQ, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX,                                                       XXXXXXX, KC_WH_L, KC_WH_U, KC_WH_R, XXXXXXX, PRTSCR1,
      DELAY, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_HUD,                                     RGB_HUI, XXXXXXX, KC_ACL0, KC_ACL1, KC_ACL2, XXXXXXX, PRTSCR2,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     HRM,                                                                           TGEXT,   RESET,    ORYX, XXXXXXX, PRTSCR3,
                                                                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                                                            XXXXXXX, XXXXXXX,
